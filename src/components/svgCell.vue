<template>
  <div>
    ...
    <!-- TODO: -->
    <!-- Make this the same size as the other SVGs -->
    <!-- Potential solution: -->
    <!-- Select another element with ref, get its height and assign it to this element -->
    <!-- Land SVG -->
    <svg
